...
- (instancetype)initWithConfiguration:(NYAlertViewControllerConfiguration *)configuration {
    ...
    if (self) {
        ...
        self.messageLabel.textColor = configuration.messageTextColor;
        ...
        [self.alertBackgroundView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|[_contentViewContainerView(0@250)]-[_titleLabel]-2-[_messageLabel][_textFieldContainerView(0@250)]-8-[_actionButtonContainerView]|"
                                                                                         options:0
                                                                                         metrics:nil
                                                                                           views:NSDictionaryOfVariableBindings(_titleLabel,
                                                                                                                                _messageLabel,
